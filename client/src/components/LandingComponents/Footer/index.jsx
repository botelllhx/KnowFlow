    ...
    <FooterContainer>
      <FooterContent>
        ...
        <NewsletterSection>
          ...
          <FooterDesc>
            Novidades sobre gestão de conhecimento e atualizações da plataforma.
          </FooterDesc>
          <NewsletterForm onSubmit={(e) => e.preventDefault()}>
            <NewsletterInput type="email" placeholder="seu@email.com" />
            <NewsletterButton type="submit">Inscrever</NewsletterButton>
          </NewsletterForm>
          <FooterTag>Sem spam. Cancele quando quiser.</FooterTag>
        </NewsletterSection>
      </FooterContent>
